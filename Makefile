##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.1.0] date: [Mon Aug 05 12:00:00 PDT 2025]
##########################################################################################################################
...
# target
######################################
TARGET = nucleo_stm32f7_vr_simulator
...
flash: $(BUILD_DIR)/$(TARGET).hex
	openocd -f interface/stlink.cfg -f target/stm32f7x.cfg -c "program $(BUILD_DIR)/$(TARGET).hex verify reset exit"
